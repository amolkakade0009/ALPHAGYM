...
const pageNavigate = () => {
 let inputElement = document.getElementById('diet-button');
  ...
  if (BMI < 18.5) {
    inputElement.innerHTML = "underweight";
    bmiCategory = "underweight";
    alert("Your weight is Underweigh");
  } else if (BMI >= 18.5 && BMI <= 24.9) {
    inputElement.innerHTML = "normalweight";
    bmiCategory = "normalweight";
    alert("Your weight is Normal");
  } else if (BMI >= 25 && BMI <= 29.9) {
    inputElement.innerHTML = "overweight";
  ...
  pageNavigate2();
    ...
    case "underweight":
      window.open("underweight.html", "_blank");
        break;
    case "normalweight":
      window.open("normalweight.html", "_blank");
        break;
    case "overweight":
      window.open("overweight.html", "_blank");
        break;
    default:
        alert("Invalid BMI category");
    }    
}
